    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="bg-black text-white p-4 rounded-full shadow-lg hover:bg-gray-800 transition-all duration-300 animate-pulse"
      ...
      {isOpen && (
        <>
          ...
          {/* Contact options */}
          <div className="fixed bottom-24 right-6 z-50 bg-white rounded-lg shadow-xl p-4 min-w-[200px]">
            <h3 className="font-serif text-lg mb-3 text-center">Get in Touch</h3>
